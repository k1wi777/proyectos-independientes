...
//esto solo se ejecuta en el primer despliegue (cuando el navegador lee el archivo) , lo que se vuelve a renderizar es lo que esté dentro de l afuncion que retorne el componente
